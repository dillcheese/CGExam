...
>>>>>>> Stashed changes
		...
		BackendHandler::imGuiCallbacks.push_back([&]() {
			if (ImGui::CollapsingHeader("World Settings "))
			{
				...
				if (ImGui::SliderFloat("Transparency", &waterTransparency, 0.01f, 1.0f))
				{
...
=======
		Texture2D::sptr water = Texture2D::LoadFromFile("images/Paint.jpg");
		Texture2D::sptr waterNorm = Texture2D::LoadFromFile("images/water_normal1.png");
		//Texture2D::sptr waterNorm = Texture2D::LoadFromFile("images/lava.jpg");
>>>>>>> Stashed changes
...
=======
		//waterMat->Set("s_Diffuse2", waterNorm);
		waterMat->Set("s_Specular", waterNorm);
>>>>>>> Stashed changes
		waterMat->Set("u_waterTransparency", waterTransparency);
		waterMat->Set("u_deepestColor", deepColor);
		waterMat->Set("u_midColor", midColor);
