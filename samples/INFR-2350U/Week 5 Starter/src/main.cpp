...
// We need to tell our scene system what extra component types we want to support
		...
		GameObject obj1 = scene->CreateEntity("Ground");
		{
			...
			obj1.emplace<RendererComponent>().SetMesh(vao).SetMaterial(grassMat).SetCastShadow(false);
			obj1.get<Transform>().SetLocalScale(1.2f, 1.2f, 1.2f);
		}
		...
		GameObject obj2 = scene->CreateEntity("Cat");
		{
			...
			obj2.get<Transform>().SetLocalScale(0.09f, 0.09f, 0.09f);
		...
		/*	EnvironmentGenerator::AddObjectToGeneration("models/simplePine.obj", simpleFloraMat, 40,
			...
			EnvironmentGenerator::AddObjectToGeneration("models/simpleTree.obj", simpleFloraMat, 40,
				spawnFromHere, spawnToHere, allAvoidAreasFrom, allAvoidAreasTo);*/
		EnvironmentGenerator::AddObjectToGeneration("models/tree4.obj", tree4Mat, 85,
			spawnFromHere, spawnToHere, allAvoidAreasFrom, allAvoidAreasTo);
		EnvironmentGenerator::AddObjectToGeneration("models/simpleRock.obj", simpleFloraMat, 4,
